		...
		setDeviceClassAdSizes:function(width) {
			try {
				...
				if (width >= this.deviceBreakpoints.wide) { // wide = 970
					...
					IDG.GPT.addSlot("topimu", [[300,600],[300,250],[160,600]]); //updated per IDGMPM-15087 to include 300x600 even on slideshows for tablet/desktop
					if (!IDG.GPT.isSlideshow) {
					...
					if (IDG.GPT.isSharedHomepage) {
						...
						IDG.GPT.addSlot("oc_ad_3", [[300,250]]);
						IDG.GPT.addSlot("oc_ad_4", [[970,90],[970,250],[728,90]]);
					}
				}
					...
					if (IDG.GPT.isSharedHomepage) {
						...
						IDG.GPT.addSlot("oc_ad_3", [[300,250]]);
						IDG.GPT.addSlot("oc_ad_4", [[728,90],[468,60]]);
					}
					...
					if (!IDG.GPT.isSlideshow) {
						...
						IDG.GPT.addSlot("topimu", [[300,600],[300,250],[160,600]]);
					}
					if (IDG.GPT.isNewHeader) {
						IDG.GPT.addSlot("oc_ad_1", [[7,7]]);
					}
